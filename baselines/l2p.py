...
class ToyModel(nn.Module):
    ...
    def __init__(self):
        ...
        f"hf-hub:timm/vit_base_patch16_224.augreg_in1k", pretrained=False,  global_pool=None
        )
...
if __name__ == '__main__':
    ...
    for epoch_idx in tqdm(range(num_epochs)):
        for batch_idx, batch in enumerate(iter_dloader):
            ...
            prompted_feat, sim_loss = ewc_module.before_backward(model, in_data, device=device)
            loss = sim_loss
