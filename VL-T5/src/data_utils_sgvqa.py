...
if __name__ == "__main__":
	...
	args = parse_args()
	scenario_dir = f'../datasets/npy_ents/function'
	data_info_path = os.path.join(scenario_dir, f'fcl_mmf_attribute_train.json')
	...
	model = NaiveBLIP2.from_pretrained(backbone, config=config,device_map="auto", )
	device = 'cuda'
